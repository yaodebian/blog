...
```
![](https://github.com/yaodebian/git_markdown_images/tree/master/Blog/css3/1/1.gif)
二.css3动画属性
| 属性 | 描述 | css版本号 |
| --- | --- | --- |
|  @keyframes |   规定动画  |  3  |
...
首先，我们先来看下效果图：
![](https://github.com/yaodebian/git_markdown_images/tree/master/Blog/css3/1/2.gif)
html:
```
  <div id="carousel-box">
    <!-- 表示图片顺序的索引 -->
